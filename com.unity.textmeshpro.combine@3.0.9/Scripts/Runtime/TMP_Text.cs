...
namespace TMPro
{
    ...
    public abstract partial class TMP_Text : MaskableGraphic
    {
        ...
        protected virtual void FillCharacterVertexBuffers(int i, int index_X4)
        {
            ...
            // Setup UVS1
            m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(0 + index_X4, characterInfoArray[i].vertex_BL.uv2, _styleParamSlot.index, _fontParamSlot.index);
            m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(1 + index_X4, characterInfoArray[i].vertex_TL.uv2, _styleParamSlot.index, _fontParamSlot.index);
            m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(2 + index_X4, characterInfoArray[i].vertex_TR.uv2, _styleParamSlot.index, _fontParamSlot.index);
            m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(3 + index_X4, characterInfoArray[i].vertex_BR.uv2, _styleParamSlot.index, _fontParamSlot.index);


            // Setup UVS2
            m_textInfo.meshInfo[materialIndex].uvs2[0 + index_X4] = new Vector4((int)CombineType, m_ClipRectIndex, CombineMaterialIndex.slotIndex);
            m_textInfo.meshInfo[materialIndex].uvs2[1 + index_X4] = new Vector4((int)CombineType, m_ClipRectIndex, CombineMaterialIndex.slotIndex);
            m_textInfo.meshInfo[materialIndex].uvs2[2 + index_X4] = new Vector4((int)CombineType, m_ClipRectIndex, CombineMaterialIndex.slotIndex);
            m_textInfo.meshInfo[materialIndex].uvs2[3 + index_X4] = new Vector4((int)CombineType, m_ClipRectIndex, CombineMaterialIndex.slotIndex);
        ...
        protected virtual void FillCharacterVertexBuffers(int i, int index_X4, bool isVolumetric)
        {
            ...
            if (isVolumetric)
            {
                m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(4 + index_X4, characterInfoArray[i].vertex_BL.uv2, _styleParamSlot.index, _fontParamSlot.index);
                m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(5 + index_X4, characterInfoArray[i].vertex_TL.uv2, _styleParamSlot.index, _fontParamSlot.index);
                m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(6 + index_X4, characterInfoArray[i].vertex_TR.uv2, _styleParamSlot.index, _fontParamSlot.index);
                m_textInfo.meshInfo[materialIndex].uvs1.SetXYZW(7 + index_X4, characterInfoArray[i].vertex_BR.uv2, _styleParamSlot.index, _fontParamSlot.index);
            }


            // Setup UVS2
            //m_textInfo.meshInfo[0].uvs2[0 + index_X4] = characterInfoArray[i].vertex_BL.uv4;
            //m_textInfo.meshInfo[0].uvs2[1 + index_X4] = characterInfoArray[i].vertex_TL.uv4;
            //m_textInfo.meshInfo[0].uvs2[2 + index_X4] = characterInfoArray[i].vertex_TR.uv4;
            //m_textInfo.meshInfo[0].uvs2[3 + index_X4] = characterInfoArray[i].vertex_BR.uv4;
        ...
        protected virtual void FillSpriteVertexBuffers(int i, int index_X4)
        {
            ...
            // Setup UVS2
            m_textInfo.meshInfo[materialIndex].uvs1.SetXY(0 + index_X4, characterInfoArray[i].vertex_BL.uv2);
            m_textInfo.meshInfo[materialIndex].uvs1.SetXY(1 + index_X4, characterInfoArray[i].vertex_TL.uv2);
            m_textInfo.meshInfo[materialIndex].uvs1.SetXY(2 + index_X4, characterInfoArray[i].vertex_TR.uv2);
            m_textInfo.meshInfo[materialIndex].uvs1.SetXY(3 + index_X4, characterInfoArray[i].vertex_BR.uv2);
        ...
        protected virtual void DrawUnderlineMesh(Vector3 start, Vector3 end, ref int index, float startScale, float endScale, float maxScale, float sdfScale, Color32 underlineColor)
        {
            ...
            Vector4[] uvs1 = m_textInfo.meshInfo[underlineMaterialIndex].uvs1;

            uvs1.SetXYZW(0 + index, (PackUV(0, 0, xScale)), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(1 + index, (PackUV(0, 1, xScale)), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(2 + index, (PackUV(max_UvX, 1, xScale)), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(3 + index, (PackUV(max_UvX, 0, xScale)), _styleParamSlot.index, _fontParamSlot.index);

            min_UvX = (vertices[index + 4].x - start.x) / (end.x - start.x);
            max_UvX = (vertices[index + 6].x - start.x) / (end.x - start.x);

            uvs1.SetXYZW(4 + index, PackUV(min_UvX, 0, xScale), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(5 + index, PackUV(min_UvX, 1, xScale), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(6 + index, PackUV(max_UvX, 1, xScale), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(7 + index, PackUV(max_UvX, 0, xScale), _styleParamSlot.index, _fontParamSlot.index);

            min_UvX = (vertices[index + 8].x - start.x) / (end.x - start.x);

            uvs1.SetXYZW(8 + index, PackUV(min_UvX, 0, xScale), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(9 + index, PackUV(min_UvX, 1, xScale), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(10 + index, PackUV(1, 1, xScale), _styleParamSlot.index, _fontParamSlot.index);
            uvs1.SetXYZW(11 + index, PackUV(1, 0, xScale), _styleParamSlot.index, _fontParamSlot.index);

            Vector4[] uvs2 = m_textInfo.meshInfo[underlineMaterialIndex].uvs2;
            for (int i = 0; i < 12; i++)
            {
                uvs2[i + index] = new Vector4((int)CombineType, m_ClipRectIndex, CombineMaterialIndex.slotIndex);
            }
            #endregion
        ...
        protected virtual void DrawTextHighlight(Vector3 start, Vector3 end, ref int index, Color32 highlightColor)
        {
            ...
            // HIGHLIGHT UV2
            #region HANDLE UV2 - SDF SCALE
            Vector4[] uvs2 = m_textInfo.meshInfo[underlineMaterialIndex].uvs1;
            Vector2 customUV = new Vector2(0, 1);
            uvs2.SetXY(0 + index, customUV);
            uvs2.SetXY(1 + index, customUV);
            uvs2.SetXY(2 + index, customUV);
            uvs2.SetXY(3 + index, customUV);
            #endregion
