...
namespace TMPro
{
    ...
    public struct TMP_MeshInfo
    {
        ...
        public TMP_MeshInfo(Mesh mesh, int size)
        {
            ...
            this.uvs1 = new Vector4[sizeX4];
            this.uvs2 = new Vector4[sizeX4];
            ...
            while (index_X4 / 4 < size)
            {
                for (int i = 0; i < 4; i++)
                {
                    ...
                    this.uvs1[index_X4 + i] = Vector4.zero;
                    this.uvs2[index_X4 + i] = Vector4.zero;
        ...
        public TMP_MeshInfo(Mesh mesh, int size, bool isVolumetric)
        {
            ...
            this.uvs1 = new Vector4[size_x_s0];
            this.uvs2 = new Vector4[size_x_s0];
            ...
            while (index_x_s0 / s0 < size)
            {
                for (int i = 0; i < s0; i++)
                {
                    ...
                    this.uvs1[index_x_s0 + i] = Vector4.zero;
                    this.uvs2[index_x_s0 + i] = Vector4.zero;
        ...
        public void SwapVertexData(int src, int dst)
        {
            ...
            // Swap UVs1
            Vector2 uv1s;
            uv1s = uvs1[dst_Index + 0];
            uvs1[dst_Index + 0] = uvs1[src_Index + 0];
            uvs1[src_Index + 0] = uv1s;

            uv1s = uvs1[dst_Index + 1];
            uvs1[dst_Index + 1] = uvs1[src_Index + 1];
            uvs1[src_Index + 1] = uv1s;

            uv1s = uvs1[dst_Index + 2];
            uvs1[dst_Index + 2] = uvs1[src_Index + 2];
            uvs1[src_Index + 2] = uv1s;

            uv1s = uvs1[dst_Index + 3];
            uvs1[dst_Index + 3] = uvs1[src_Index + 3];
            uvs1[src_Index + 3] = uv1s;

            // Swap UVs2
            Vector2 uv2s;
            uv2s = uvs2[dst_Index + 0];
            uvs2[dst_Index + 0] = uvs2[src_Index + 0];
            uvs2[src_Index + 0] = uv2s;

            uv2s = uvs2[dst_Index + 1];
            uvs2[dst_Index + 1] = uvs2[src_Index + 1];
            uvs2[src_Index + 1] = uv2s;

            uv2s = uvs2[dst_Index + 2];
            uvs2[dst_Index + 2] = uvs2[src_Index + 2];
            uvs2[src_Index + 2] = uv2s;

            uv2s = uvs2[dst_Index + 3];
            uvs2[dst_Index + 3] = uvs2[src_Index + 3];
            uvs2[src_Index + 3] = uv2s;
