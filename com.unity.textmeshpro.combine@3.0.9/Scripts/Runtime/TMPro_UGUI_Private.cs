...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI
    {
        ...
        protected override void OnDestroy()
        {
            ...
            if (_styleParamSlot.IsValid())
            {
                TMP_CombineRenderManager.FreeSlot(ref _styleParamSlot);
            }
        }
        ...
        protected override void OnValidate()
        {
            ...
            if (m_canvasRenderer == null || m_canvasRenderer.GetMaterial() == null || m_canvasRenderer.GetMaterial().GetTextureEx(ShaderUtilities.ID_MainTex) == null
                || m_fontAsset == null || m_fontAsset.atlasTexture.GetInstanceID() != m_canvasRenderer.GetMaterial().GetTextureInstanceID(ShaderUtilities.ID_MainTex))
            {
                LoadFontAsset();
                m_hasFontAssetChanged = false;
            }
            ...
            */
            ...
            for (int i = 0; i < materialCount; i++)
            {
                ...
                if (i > 0)
                {
                    ...
                    {
                        m_subTextObjects[i] = TMP_SubMeshUI.AddSubTextObject(this, m_materialReferences[i], i);
        ...
        protected virtual void GenerateTextMesh()
        {
            ...
            if (m_renderMode == TextRenderFlags.Render && IsActive())
            {
                ...
                m_mesh.SetUVs(1, m_textInfo.meshInfo[0].uvs1);
                m_mesh.SetUVs(2, m_textInfo.meshInfo[0].uvs2);
                ...
                for (int i = 1; i < m_textInfo.materialCount; i++)
                {
                    ...
                    m_subTextObjects[i].UpdateMeshInfo();
                    ...
                    m_subTextObjects[i].mesh.SetUVs(1, m_textInfo.meshInfo[i].uvs1);
                    m_subTextObjects[i].mesh.SetUVs(2, m_textInfo.meshInfo[i].uvs2);
        ...
        void UpdateSDFScale(float scaleDelta)
        {
            ...
            for (int materialIndex = 0; materialIndex < m_textInfo.materialCount; materialIndex ++)
            {
                ...
                for (int i = 0; i < meshInfo.uvs1.Length; i++)
                {
                    meshInfo.uvs1[i].y *= Mathf.Abs(scaleDelta);
                }
            }
