    ...
    public partial class TextMeshProUGUI : TMP_Text, ILayoutElement
    {
        ...
        public override Material materialForRendering
        {
            get
            {
                ...
                if (TryCombineEx(font.atlasTexture))
                {
        ...
        protected override void UpdateMaterial()
        {
            ...
            {
                m_canvasRenderer.SetTexture(s_WhiteTexture);
                m_canvasRenderer.DisableRectClipping();
            }
            else
            {
                m_canvasRenderer.SetTexture(null);
            }
        }
        ...
        public override void UpdateVertexData(TMP_VertexDataUpdateFlags flags)
        {
            ...
            for (int i = 0; i < materialCount; i++)
            {
                ...
                if ((flags & TMP_VertexDataUpdateFlags.Uv1) == TMP_VertexDataUpdateFlags.Uv1)
                    mesh.SetUVs(1, m_textInfo.meshInfo[i].uvs1);

                if ((flags & TMP_VertexDataUpdateFlags.Uv2) == TMP_VertexDataUpdateFlags.Uv2)
                    mesh.SetUVs(2, m_textInfo.meshInfo[i].uvs2);
