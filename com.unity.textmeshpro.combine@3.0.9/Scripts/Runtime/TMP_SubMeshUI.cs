...
namespace TMPro
{
    ...
    public partial class TMP_SubMeshUI : MaskableGraphic
    {
        ...
        public override Material materialForRendering
        {
            get
            {
                ...
                if (TryCombineEx(mainTexture))
                {
                    UsedCombineMaterial = true;
                    renderMat = m_CombineMaterial;
                }
                else
                {
                    UsedCombineMaterial = false;
                    renderMat = m_sharedMaterial;
                }

                renderMat = TMP_MaterialManager.GetMaterialForRendering(this, renderMat);
                return renderMat;
            }
        }
        ...
        /// <returns></returns>
        public static TMP_SubMeshUI AddSubTextObject(TextMeshProUGUI textComponent, MaterialReference materialReference, int subIndex)
        {
            ...
            subMesh.UseCanvasCombine = textComponent.UseCanvasCombine;
            subMesh.m_SubIndex = subIndex;
        ...
        void SetSharedMaterial(Material mat)
        {
            ...
            isSupportUnifiedRendering = m_sharedMaterial != null && m_sharedMaterial.shader != null
