...
namespace TMPro.EditorUtilities
{
    ...
    public class TMP_EditorPanelUI : TMP_BaseEditorPanel
    {
        ...
        static readonly GUIContent k_UseCanvasCombineLabel = new GUIContent("Use Canvas Combine", "");
        ...
        protected void DrawUseCanvasCombie()
        {
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.PropertyField(m_UseCanvasCombineProp, k_UseCanvasCombineLabel);
            if (EditorGUI.EndChangeCheck())
            {
                m_HavePropertiesChanged = true;
                if (Application.isPlaying && (target is Graphic graphic))
                {
                    graphic.UseCanvasCombine = m_UseCanvasCombineProp.boolValue;
                }
            }
        }
