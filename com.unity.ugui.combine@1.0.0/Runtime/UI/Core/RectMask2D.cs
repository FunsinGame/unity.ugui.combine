...
namespace UnityEngine.UI
{
    ...
    public class RectMask2D : UIBehaviour, IClipper, ICanvasRaycastFilter
    {
        ...
        protected override void OnDisable()
        {
            ...
            MaskUtilities.Notify2DMaskStateChanged(this);
            CombineRenderManager.FreeClipRect(this);
            _clipIndex = -1;
        }
        ...
        public virtual void PerformClipping()
        {
            ...
            if (CombineRenderManager.IsOpen)
            {
                _clipIndex = CombineRenderManager.GetClipRectIndex(this, clipRect, m_Softness);
            }
            else
            {
                _clipIndex = -1;
            ...
            if (clipRect != m_LastClipRectCanvasSpace)
            {
                ...
                {
                    clipTarget.SetClipRect(clipRect, validRect, _clipIndex);
                }

                foreach (MaskableGraphic maskableTarget in m_MaskableTargets)
                {
                    maskableTarget.SetClipRect(clipRect, validRect, _clipIndex);
        ...
        public void RemoveClippable(IClippable clippable)
        {
            ...
            clippable.SetClipRect(new Rect(), false, 0);
