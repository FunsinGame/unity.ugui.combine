...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public abstract partial class MaskableGraphic : Graphic, IClippable, IMaskable, IMaterialModifier
    {
        [NonSerialized]
        ...
        public virtual Material GetModifiedMaterial(Material baseMaterial)
        {
            ...
            if (m_StencilValue > 0 && !isMaskingGraphic)
            {
                ...
                CanvasCombiner?.UpdateStencilMaterial(CombineMaterialIndex, toUse);
            }
            return toUse;
        }
