...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    public partial class Image : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        /// <summary>
        ...
        protected override void OnPopulateMesh(VertexHelper toFill)
        {
            ...
            toFill.SetUnifiedValue(new Vector4((int)CombineType, m_ClipRectIndex, CombineMaterialIndex.slotIndex));
        }
