...
namespace UnityEditor.UI
{
    ...
    static internal class MenuOptions
    {
        ...
        static private DefaultControls.Resources GetStandardResources()
        {
            ...
            {
                s_StandardResources.standard = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/UISprite.png");
                s_StandardResources.background = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/Background.png");
                s_StandardResources.inputField = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/InputFieldBackground.png");
                s_StandardResources.knob = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/Knob.png");
                s_StandardResources.checkmark = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/Checkmark.png");
                s_StandardResources.dropdown = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/DropdownArrow.png");
                s_StandardResources.mask = AssetDatabase.LoadAssetAtPath<Sprite>("Assets/Arts/UI/Atlas/Common/buildinSprite/UIMask.png");
            }
